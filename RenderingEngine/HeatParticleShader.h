...
public:
	HeatParticleShader(std::map<GLenum, std::string> defines = std::map<GLenum, std::string> defines{});

	virtual bool createProgram(std::map<GLenum, std::string> defines = std::map<GLenum, std::string> defines{});
